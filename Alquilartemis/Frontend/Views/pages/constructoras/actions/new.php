...
if(isset($_POST['guardar'])){
    ...
    $url = 'http://localhost/alquilartemis-api-master/Alquilartemis/Backend/Controllers/Constructoras.php?op=insert';
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form class="col d-flex flex-wrap" id="notas" method="POST">
              <div class="m-2 col-8">
                <label for="exampleInputPassword1" class="form-label">Nombre Constructora</label>
